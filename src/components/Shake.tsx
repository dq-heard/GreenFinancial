export const Shake = () => {
  return (
    <div className="shake-container">
      <div className="shake-icon-wrapper">
        <span className="shake-svg">
          <svg
            width="21"
            height="21"
            viewBox="0 0 21 21"
      ...
      <div className="shake-text-container">
        <span className="shake-label"> Give Us a Call Today: </span>
        <span className="shake-phone-number"> (615) 902-5322 </span>
      </div>
    </div>
  );
};
